...
def save_article_json(
    ...
    article_data = {
        ...
        "link": link,
        "pub_date": pub_date,
        "generated_date": get_beijing_date()
    }

    output_path = "article.json"
...
def main():
    ...
    print(
        "\n下一步将由 wechat_test.py"
    )

    print(
        "读取 article.json 并提交微信公众号草稿箱。"
    )
